    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <a href="/" className="flex items-center gap-3 cursor-pointer group">
          <div className="w-10 h-10 bg-[#0F172A] text-white rounded flex items-center justify-center font-bold text-lg group-hover:bg-blue-700 transition-colors">
            AE
          </div>
          <div>
            <h1 className="text-xl font-bold text-[#0F172A] leading-tight">
              Oasis<span className="text-blue-700">.ai</span>
            </h1>
        ...
        <nav className="hidden md:flex gap-6 text-sm font-medium text-[#0F172A]">
          ...
          <Link href="/page/services" className="hover:text-blue-700 transition-colors">Services</Link>
          <Link href="/page/regulations" className="hover:text-blue-700 transition-colors">Regulations</Link>
          <Link href="/page/support" className="hover:text-blue-700 transition-colors">Help & Support</Link>
        </nav>
