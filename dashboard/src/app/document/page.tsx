...
import { ShieldCheck, FileText, CheckCircle2, ChevronRight, ChevronLeft, Download, Terminal } from 'lucide-react';
...
export default function DocumentAuditor() {
  ...
  const getAgentColor = (agentName: string) => {
    ...
    if (name.includes('translator')) return 'text-blue-400';
    if (name.includes('auditor')) return 'text-red-400';
    if (name.includes('assessor')) return 'text-emerald-400';
